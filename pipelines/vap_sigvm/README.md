# SigVM Ingest Collation Transformation Pipeline

The SigVM Ingest Collation transformation pipeline was created from a cookiecutter template. This README file contains
...
2. Run `runner.py` and specify the transformation pipeline that should run:
        ...
        ```shell
        python runner.py vap pipelines/vap_sigvm/config/pipeline.yaml -b 20230324 -e 20230325
        ```
